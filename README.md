...
Предполагается, что проводится модель испытаний Бернулли с вероятностью успеха $p$. Вероятность успеха считается с помощью нормировки рейтинга на `max_rating`.
